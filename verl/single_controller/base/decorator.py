...
def _split_args_kwargs_data_proto(chunks, *args, **kwargs):
    ...
    from verl.protocol_dict import DataProto as DataProto_dict
    splitted_args = []
    for arg in args:
        assert isinstance(arg, (DataProto, DataProtoFuture, DataProto_dict))
        splitted_args.append(arg.chunk(chunks=chunks))

    splitted_kwargs = {}
    for key, val in kwargs.items():
        assert isinstance(val, (DataProto, DataProtoFuture, DataProto_dict))
