...
from eval_agent.prompt import prompt_only, prompt_with_icl, prompt_only_for_sciworld
...
class SciWorldEnv(BaseEnv):
    ...
    def reset(self) -> Tuple[str, State]:
        ...
        if self.prompt == "v1":
            ...
            observation, messages = prompt_only_for_sciworld(self.instruction, cur_task, obs)
