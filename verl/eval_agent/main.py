...
def interactive_loop(
    ...
    logger.info(
                f"\n{Fore.GREEN}{state.history}{Fore.RESET}\n"
            )
...
def main(args: argparse.Namespace):
    ...
    output_path = os.path.join("eval_outputs", agent_config['config']['model_name'].replace('/', '_'), args.exp_config+"_"+args.split)
    ...
    if args.exp_config == "alfworld_v2":
        os.environ['ALFWORLD_DATA'] = "Embodied-Planner-R1/get_data/alfworld" # change to your own alfworld data
    ...
    if os.path.exists(output_path) and not args.override:
        for file in os.listdir(output_path):
            ...
            if "Error code: 401" in state.terminate_reason:
                continue
